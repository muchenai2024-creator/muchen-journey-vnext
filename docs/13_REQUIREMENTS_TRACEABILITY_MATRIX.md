...
| WP-08 物理独立 Staging | ISO-MUST-003/004/007/008/009/012；DEC-003/013/014；AT-ISO-002/003/005；AT-ARCH-002/003/005 | `make wp08-staging-readiness`、`make wp08-staging-apply-check`、`make wp08-workflow-check`、Terraform validate 与 saved-plan destroy/replacement guard；DoR 与路径证据见 25/26 | run 29994013611 已完成 provision 收敛；新 RDS CA 已写入 GitHub `staging` Environment。首次 deploy run 29997923817 在 CloudControl 安全组更新处安全停止并恢复 SSH 关闭态；最小修复改为同一 workflow 直接添加/撤销精确 runner `/32`，不新增资源、provider 或 IAM。migration、应用部署、TLS 和物理隔离验收仍 `NOT_RUN` | `DEPLOY_REMEDIATION_READY`；WP-09 未激活，整体发布仍 `NO_GO` |
