...
2026-07-22 用户进一步锁定火山引擎、华北2（北京）`cn-beijing`、按量计费、¥500/月、独立 IAM/VPC/SG/ECS/RDS/TOS/staging 域名，并授权候选 `ff07ce47d20f3f6eb09d633b09292628fbb58e2a` 创建与部署。仓库唯一 IaC/CI/secret/回滚路径见 26 号文档及 `docs/runbooks/WP08_VOLCENGINE_STAGING.md`。同日官方报价核验得出 ECS ¥177.26/月、最小 RDS PostgreSQL 高可用主备 ¥540/月，两项小计 ¥717.26/月且未含 TOS/备份/流量，超过上限 ¥217.26。当前状态为 `STOPPED_BUDGET_GATE_NO_DEPLOY`，云端未写入，不得启动 WP-09。
