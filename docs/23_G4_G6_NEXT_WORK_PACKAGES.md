...
2026-07-22 用户进一步锁定火山引擎、华北2（北京）`cn-beijing`、按量计费、¥500/月、独立 IAM/VPC/SG/ECS/RDS/TOS/staging 域名，并授权候选 `ff07ce47d20f3f6eb09d633b09292628fbb58e2a` 创建与部署。仓库唯一 IaC/CI/secret/回滚路径见 26 号文档及 `docs/runbooks/WP08_VOLCENGINE_STAGING.md`。当前火山引擎仍未登录、同日报价为空且云端未写入，因此状态为 `IMPLEMENTATION_PATH_READY_CLOUD_NOT_APPLIED`，不得启动 WP-09。
