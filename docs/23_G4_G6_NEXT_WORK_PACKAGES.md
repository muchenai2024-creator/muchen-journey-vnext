...
2026-07-22 用户进一步锁定火山引擎、华北2（北京）`cn-beijing`、按量计费、独立 IAM/VPC/SG/ECS/RDS/TOS/staging 域名，并授权候选 `ff07ce47d20f3f6eb09d633b09292628fbb58e2a` 创建与部署。首次 ¥500/月尝试因 ECS ¥177.26/月与最小 RDS PostgreSQL 高可用主备 ¥540/月合计 ¥717.26/月而停止，云端未写入。随后用户将预算提高为 ¥800/月并保留托管 RDS，同时授权 Next.js 16.2.11 与 sharp 0.35.3 安全修复。当前状态为 `BUDGET_REAUTHORIZED_PATCHED_CANDIDATE_PENDING`：已核固定基线低于新上限，剩余约 ¥82.74 用于 TOS、备份和公网流量；须先完成依赖复验、新候选与同日总报价刷新，才能创建资源或部署，WP-09 仍不得启动。
