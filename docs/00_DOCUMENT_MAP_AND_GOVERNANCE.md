...
| 26 | [WP-08 火山引擎 Staging 实施路径证据](26_WP08_VOLCENGINE_STAGING_PATH_EVIDENCE.md) | 已锁定 provider/region/budget 后，唯一 IaC/CI/secret/回滚路径是什么，云端是否已经写入？ | provision 已冻结；Alpha deploy 仅读取 state，不运行 IaC/provider 写路径，等待受保护主线复验和独立部署授权 |
